...
export abstract class MongooseDocument {
    ...
    public save?(...args: any[]): Promise<this> & void { return }
    // public save?(optionsOrCb?: (SaveOptions | ((err: any, product: this) => void)), cbOrOptions?: (SaveOptions | ((err: any, product: this) => void))): Promise<this> | void { return }
