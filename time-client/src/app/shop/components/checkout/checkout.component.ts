...
export class CheckoutComponent implements OnInit {
    ...
    public ngOnInit(): void {
        ...
        // this.cart = this.util.getFromLocalStorage('cart')

        /*
        this.checkoutService.getStripeKey().subscribe(
            key => {
                stripe = (<any>window).Stripe(key)
                this.initStripeForm()
    ...
    public populateOrder(): void {
        ...
        this.organizationService.organization$.subscribe(organization => {
            ...
            // this.order.taxPercent = this.organization.settings.addSalesTax ? this.organization.settings.salesTaxPercent : 0
            // this.order.shippingCost = this.organization.settings.shippingFlatRate
