...
const commonDest = path.resolve(__dirname, '../time-client/src/client/app/common');
const appConfigSrc = path.resolve(__dirname, '../app-config.ts');
const appConfigDest = path.resolve(__dirname, '../time-client/src/client/app/app-config.ts');
