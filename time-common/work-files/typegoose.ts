...
export class Typegoose {
  ...
  setModelForClass<T>(t: T, { existingMongoose, schemaOptions, existingConnection }: GetModelForClassOptions = {}) {
    ...
    let grandParentCtor = Object.getPrototypeOf(parentCtor.prototype).constructor;
    // iterate trough all parents

    if (grandParentCtor && grandParentCtor.name !== 'Typegoose' && grandParentCtor.name !== 'Object') {
        parentCtor = grandParentCtor;
    }
